...
RUN		sudo apt-get install software-properties-common apt-transport-https curl -y
...
RUN 	sudo apt-get install -y git dotnet-sdk-2.0.0 libopus0 opus-tools libopus-dev libsodium-dev ffmpeg rsync python python3-pip redis-server
